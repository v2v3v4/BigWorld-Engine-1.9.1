...
EditorAmbientLight::EditorAmbientLight()
{
	...
	pColProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/AMBIENT_COLOUR" );
...
OmniLight::OmniLight()
{
	...
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/OMNI_COLOUR" );
	...
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/OMNI_POSITION" );
	editor_->addProperty( pProp );
	...
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/OMNI_RADIUS" );
	editor_->addProperty( pProp );
	...
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/OMNI_FALLOFF" );
	editor_->addProperty( pProp );
	...
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/OMNI_INTENSITY" );
	editor_->addProperty( pProp );
...
DirLight::DirLight()
{
	...
	pProp = new ColourProperty( "MODELEDITOR/MODELS/LIGHTS/COLOUR", colourProxy );
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/DIRECTIONAL_COLOUR" );
	editor_->addProperty( pProp );
	...
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/DIRECTIONAL_DIRECTION" );
	editor_->addProperty( pProp ); 
	...
	FloatProxyPtr multiplierProxy = new MeLightFloatProxy<Moo::DirectionalLight>(
		...
		1.f);
	pProp = new GenFloatProperty( "MODELEDITOR/MODELS/LIGHTS/MULTIPLIER", multiplierProxy );
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/DIRECTIONAL_INTENSITY" );
	editor_->addProperty( pProp );
...
SpotLight::SpotLight()
{
	...
	pProp = new ColourProperty( "MODELEDITOR/MODELS/LIGHTS/COLOUR", colourProxy );
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/SPOT_COLOUR" );
	editor_->addProperty( pProp );
	...
	matrixProxy_ = new MeSpotLightPosDirMatrixProxy<Moo::SpotLight>(
		...
		&matrix_ );
	pProp = new GenPositionProperty( "MODELEDITOR/MODELS/LIGHTS/POSITION", matrixProxy_);
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/SPOT_POSITION" );
	editor_->addProperty( pProp );
	pProp = new GenRotationProperty( "MODELEDITOR/MODELS/LIGHTS/DIRECTION", matrixProxy_);
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/SPOT_DIRECTION" );
	editor_->addProperty( pProp );
	...
	FloatProxyPtr minRadiusProxy = new MeLightFloatProxy<Moo::SpotLight>(
		...
		10.f);
	pProp = new GenRadiusProperty("MODELEDITOR/MODELS/LIGHTS/RADIUS", minRadiusProxy, matrixProxy_, 0xbf10ff10, 2.f );
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/SPOT_RADIUS" );
	editor_->addProperty( pProp );
	...
	FloatProxyPtr maxRadiusProxy = new MeLightFloatProxy<Moo::SpotLight>(
		...
		20.f);
	pProp = new GenRadiusProperty("MODELEDITOR/MODELS/LIGHTS/FALLOFF", maxRadiusProxy, matrixProxy_, 0xbf1010ff, 4.f);
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/SPOT_FALLOFF" );
	editor_->addProperty( pProp );
	...
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/SPOT_CONE_ANGLE" );
	editor_->addProperty( pProp );
	...
	FloatProxyPtr multiplierProxy = new MeLightFloatProxy<Moo::SpotLight>(
		...
		1.f);
	pProp = new GenFloatProperty( "MODELEDITOR/MODELS/LIGHTS/MULTIPLIER", multiplierProxy );
	pProp->UIDesc( "MODELEDITOR/MODELS/LIGHTS/SPOT_INTENSITY" );
	editor_->addProperty( pProp );
...
bool Lights::save( const std::string& name /* = "" */ )
{
	...
	ME_INFO_MSG( L("MODELEDITOR/MODELS/LIGHTS/SAVING", currName_ ) );
