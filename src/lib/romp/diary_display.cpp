...
void DiaryDisplay::drawDisplay()
{
	...
	if (!textMesh_.empty())
	{
		static FontPtr myfont = FontManager::instance().get( "default_small.font" );
...
{
	static FontPtr myfont = FontManager::instance().get( "system_small.font" );	
...
{
	font_ = FontManager::instance().get( "system_small.font" );
}
