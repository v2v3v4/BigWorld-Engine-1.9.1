...
//	memNow( "Before base script init" );
	...
	std::string paths = EntityDef::Constants::entitiesClientPath();
	paths += ";";
	paths += EntityDef::Constants::userDataObjectsClientPath();
 ...
 *	This method takes a screenshot and writes the image to your
 ...
 *	Eject all chunks, purge all ".chunk" data sections and begin reloading
 *	the space.
 */
void reloadChunks()
{
