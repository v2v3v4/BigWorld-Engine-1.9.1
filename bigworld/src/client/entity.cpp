...
/*~ callback Entity.controlled
 *
 *	This callback method lets an entity know whether it is now being
 *	controlled locally by player physics, instead of the server.  It happens
 *	in response to a call to BigWorld.controlEntity
 *
 *	@see BigWorld.controlEntity
