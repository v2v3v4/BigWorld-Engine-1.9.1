 ...
 */
static void debugNearPlane(PyObject * camera)
{
	BW_GUARD;
	...
	if (camera)
	{
		...
		CursorCamera * cursorCamera = static_cast<CursorCamera *>( camera );
...
PY_AUTO_MODULE_FUNCTION(
	RETVOID, debugNearPlane, OPTARG(PyObject *, NULL, END), BigWorld )
